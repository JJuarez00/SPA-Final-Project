 ...
 * Date: 11/13/2025
 * File: home.jsx
 * Description: Displays the home page of the Video Game SPA
 */
    ...
    return (
        <>
            ...
            <div className="sub-heading">
                <div className="container">Welcome to the Videogame Application</div>
            </div>
            ...
            <div className="main-content container">
                ...
                <p>This application is an API client. Data of the application is provided by an API service called <strong>Videogame-API</strong>.
